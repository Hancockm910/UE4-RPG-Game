...
#include "Public\ColliderMovementComponents.h"
...
ACollider::ACollider()
{
	...
	MovementComponent = CreateDefaultSubobject<UColliderMovementComponents>(TEXT("MovementComponent"));
...
void ACollider::MoveForward(float Value)
{
	...
	{
		MovementComponent->AddInputVector(Value * Forward);
	}
}
...
void ACollider::MoveRight(float Value)
{
	...
	if (MovementComponent)
	{
		MovementComponent->AddInputVector(Value * Right);
	}
}
